-- WordWise Database Schema (FIXED VERSION)
...
-- FIXED: Function to calculate word count automatically
...
-- FIXED: Simplified trigger without WHEN clause
...
-- Success message
SELECT 'WordWise database schema created successfully! 🎉' as result; 